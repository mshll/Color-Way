...
//  Repo: https://github.com/Codigami/CFAlertViewController
//
//  Edited by Meshal Almutairi on 06/24/21
//
...
open class CFAlertViewController: UIViewController    {
    ...
    @objc public convenience init(title: String?,
        ...
        containerBackgroundColor = CFAlertViewController.CF_ALERT_DEFAULT_CONTAINER_VIEW_BACKGROUND_COLOR()
        titleString = title
    ...
    internal func loadDisplayContent() {
        ...
        // Reload Container Background Color
        let containerBackgroundColorValue = containerBackgroundColor
        containerBackgroundColor = containerBackgroundColorValue
